...
namespace Service.MatchingEngine.EventBridge.Settings
{
    ...
    public class SettingsModel
    {
        ...
        [YamlProperty("MatchingEngineEventBridge.RabbitMq.ConnectionString")]
        public string RabbitMqConnectionString { get; set; }
        [YamlProperty("MatchingEngineEventBridge.RabbitMq.Exchange")]
        public string RabbitMqExchange { get; set; }
        [YamlProperty("MatchingEngineEventBridge.RabbitMq.QueryName")]
        public string RabbitMqQueryName { get; set; }
    }
}